...
class ScreeningForAngnwadiClassFormFour extends StatefulWidget {
  const ScreeningForAngnwadiClassFormFour({super.key});

  @override
  State<ScreeningForAngnwadiClassFormFour> createState() => _ScreeningForAngnwadiClassFormFourState();
}

class _ScreeningForAngnwadiClassFormFourState extends State<ScreeningForAngnwadiClassFormFour> {
   Map<String, bool> diseases = {
    'Skin Conditions Not Leprosy': false,
    'Otitis Media': false,
    'Rheumatic Heart Disease': false,
    'Reactive Airway Disease': false,
    'Dental Conditions': false,
    'Childhood Leprosy Disease': false,
    'Childhood Tuberculosis': false,
    'Childhood Tuberculosis (Extra Pulmonary)': false,
    'Others': false,
  };
