          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  children: List.generate(bloodPressureOptions.length, (index) {
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          SizedBox(
                            ...
                            height: 20,
                            child: Checkbox(
                              value: bloodPressureSelections[index],
                              onChanged: (bool? value) {
                                setState(() {
                                  bloodPressureSelections[index] = value ?? false;
                                });
                              },
