...
class ScreeningForClassFormSix extends StatefulWidget {
  ...
  const ScreeningForClassFormSix({super.key, required this.previousData});

  @override
  State<ScreeningForClassFormSix> createState() =>
      _ScreeningForClassFormSixState();
}
